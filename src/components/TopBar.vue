    ...
    >
        ...
        <v-menu offset-y>
            <template v-slot:activator="{ on, attrs }">
                <v-btn text class="mr-3 profile-button" v-bind="attrs" v-on="on">
            ...
            <v-list class="text-start">
                ...
                <v-list-item link dense>
                    <v-list-item-title><v-icon class="mr-3" color="black" small>mdi-wrench</v-icon>Settings</v-list-item-title>
                </v-list-item>
                <v-list-item link dense>
